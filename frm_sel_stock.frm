...
Begin VB.Form frm_sel_stock 
   ...
   End
End
Attribute VB_Name = "frm_sel_stock"
...
Private Sub Cmd_Lihat_Click()
    ...
    sql = "select * from VIEW_Jml_Stock order by jenis,kode asc"
    ...
    If Txt_Kode.Text <> "" Or Txt_Nama.Text <> "" Or Tgl_Lhr1.Text <> "__/__/____" Or Tgl_Lhr2.Text <> "__/__/____" Or Txt_Alamat.Text <> "" Or _
        ...
        sql = "select * from VIEW_Jml_Stock where"
...
'        End If
        ...
        sql = sql & " order by jenis,kode asc"
