...
Begin VB.Form frm_sel_brg_masuk 
   ...
   EndProperty
   Icon            =   "frm_sel_brg_masuk.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin IsButton_Ard.isButton Cmd_Lihat 
         ...
         _ExtentX        =   1720
         _ExtentY        =   873
         Icon            =   "frm_sel_brg_masuk.frx":27C92
         Style           =   8
         Caption         =   "&Tampil"
         iNonThemeStyle  =   0
         Tooltiptitle    =   ""
      ...
      Begin IsButton_Ard.isButton Cmd_Keluar 
         ...
         _ExtentX        =   1720
         _ExtentY        =   873
         Icon            =   "frm_sel_brg_masuk.frx":27CAE
         Style           =   8
         Caption         =   "&Keluar"
         iNonThemeStyle  =   0
         Tooltiptitle    =   ""
   ...
   End
End
Attribute VB_Name = "frm_sel_brg_masuk"
...
Private Sub Cmd_Lihat_Click()
    ...
    sql = "select  * from VIEW_BrgMasuk_All"
...
'        End If
    ...
    If Txt_Kode.Text <> "" Or Txt_Nama.Text <> "" Or Tgl_Lhr1.Text <> "__/__/____" Or Tgl_Lhr2.Text <> "__/__/____" Or Txt_Alamat.Text <> "" Or _
        ...
        sql = "select * from VIEW_BrgMasuk_All where"
...
'        End If
        ...
        If Txt_Nama.Text <> "" And Txt_Kode.Text = "" Then
            sql = sql & " bukti_order like '%" & Trim(Txt_Nama.Text) & "%'"
        End If
        
        If Txt_Nama.Text <> "" And Txt_Kode.Text <> "" Then
            sql = sql & " and bukti_order like '%" & Trim(Txt_Nama.Text) & "%'"
        End If
        ...
        If Txt_Alamat.Text <> "" And Tgl_Lhr1.Text = "__/__/____" And Tgl_Lhr2.Text = "__/__/____" And Txt_Nama.Text = "" And Txt_Kode.Text = "" Then
            sql = sql & " namabrg like '%" & Trim(Txt_Alamat.Text) & "%'" ' or Alamat_2 like '%" & Trim(Txt_Alamat.Text) & "%' or Alamat_3 like '%" & Trim(Txt_Alamat.Text) & "%'"
        End If

        If Txt_Alamat.Text <> "" And ((Tgl_Lhr1.Text <> "__/__/____" And Tgl_Lhr2.Text <> "__/__/____") Or Txt_Nama.Text <> "" Or Txt_Kode.Text <> "") Then
            sql = sql & " and namabrg like '%" & Trim(Txt_Alamat.Text) & "%'" ' or Alamat_2 like '%" & Trim(Txt_Alamat.Text) & "%' or Alamat_3 like '%" & Trim(Txt_Alamat.Text) & "%'"
        End If
        ...
        If Txt_Telp.Text <> "" And Txt_Alamat.Text = "" And Tgl_Lhr1.Text = "__/__/____" And Tgl_Lhr2.Text = "__/__/____" And Txt_Nama.Text = "" And Txt_Kode.Text = "" Then
            sql = sql & " atas_nama like '%" & Trim(Txt_Telp.Text) & "%'" ' or No_telp_Hp like '%" & Trim(Txt_Telp.Text) & "%'"
        End If
        ...
        If Txt_Telp.Text <> "" And (Txt_Alamat.Text <> "" Or (Tgl_Lhr1.Text <> "__/__/____" And Tgl_Lhr2.Text <> "__/__/____") Or Txt_Nama.Text <> "" Or Txt_Kode.Text <> "") Then
            sql = sql & " and atas_nama like '%" & Trim(Txt_Telp.Text) & "%'" 'or No_telp_Hp like '%" & Trim(Txt_Telp.Text) & "%'"
        End If
